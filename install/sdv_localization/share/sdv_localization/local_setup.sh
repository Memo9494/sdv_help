...
: ${AMENT_CURRENT_PREFIX:="/workspaces/isaac_ros-dev/install/sdv_localization"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sdv_localization/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sdv_localization/environment/path.sh"
