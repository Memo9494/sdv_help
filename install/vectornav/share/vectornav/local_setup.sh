...
: ${AMENT_CURRENT_PREFIX:="/workspaces/isaac_ros-dev/install/vectornav"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/vectornav/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/vectornav/environment/path.sh"
