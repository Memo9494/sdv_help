...
bool vision_msgs__msg__vision_class__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_msgs.msg._vision_class.VisionClass", full_classname_dest, 41) == 0);
  }
  vision_msgs__msg__VisionClass * ros_message = _ros_message;
  {  // class_id
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * vision_msgs__msg__vision_class__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of VisionClass */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_msgs.msg._vision_class");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VisionClass");
  ...
  vision_msgs__msg__VisionClass * ros_message = (vision_msgs__msg__VisionClass *)raw_ros_message;
  {  // class_id
    PyObject * field = NULL;
