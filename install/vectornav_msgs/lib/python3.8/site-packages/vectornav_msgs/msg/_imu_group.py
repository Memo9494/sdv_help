...
class ImuGroup(metaclass=Metaclass_ImuGroup):
    ...
    def temp(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'temp' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._temp = value
    ...
    def pres(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'pres' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._pres = value
    ...
    def deltatheta_time(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'deltatheta_time' field must be a float in [-3.402823e+38, 3.402823e+38]"
