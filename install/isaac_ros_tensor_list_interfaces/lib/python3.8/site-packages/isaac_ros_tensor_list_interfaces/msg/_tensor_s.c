...
bool isaac_ros_tensor_list_interfaces__msg__tensor_shape__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool isaac_ros_tensor_list_interfaces__msg__tensor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isaac_ros_tensor_list_interfaces.msg._tensor.Tensor", full_classname_dest, 51) == 0);
  }
  isaac_ros_tensor_list_interfaces__msg__Tensor * ros_message = _ros_message;
  {  // name
  ...
  {  // shape
    ...
    if (!isaac_ros_tensor_list_interfaces__msg__tensor_shape__convert_from_py(field, &ros_message->shape)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // data_type
    ...
    ros_message->data_type = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // strides
    PyObject * field = PyObject_GetAttrString(_pymsg, "strides");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      uint64_t * dest = ros_message->strides.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'strides'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of Tensor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isaac_ros_tensor_list_interfaces.msg._tensor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Tensor");
  ...
  {  // shape
    PyObject * field = NULL;
    field = isaac_ros_tensor_list_interfaces__msg__tensor_shape__convert_to_py(&ros_message->shape);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // data_type
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->data_type);
    {
  ...
  {  // strides
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "strides");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->strides.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint64_t * src = &(ros_message->strides.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->strides.size * sizeof(uint64_t));
      assert(data != NULL);
