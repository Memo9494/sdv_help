...
: ${AMENT_CURRENT_PREFIX:="/workspaces/isaac_ros-dev/install/multisense_ros"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/multisense_ros/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/multisense_ros/environment/path.sh"
