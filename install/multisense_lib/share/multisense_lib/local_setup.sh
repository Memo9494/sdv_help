...
: ${AMENT_CURRENT_PREFIX:="/workspaces/isaac_ros-dev/install/multisense_lib"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/multisense_lib/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/multisense_lib/environment/library_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/multisense_lib/environment/path.sh"
