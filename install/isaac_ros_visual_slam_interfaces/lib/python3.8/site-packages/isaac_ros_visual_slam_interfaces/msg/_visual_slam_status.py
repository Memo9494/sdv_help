...
class VisualSlamStatus(metaclass=Metaclass_VisualSlamStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.integrator_state = kwargs.get('integrator_state', int())
    ...
    def __eq__(self, other):
        ...
        if self.vo_state != other.vo_state:
            return False
        if self.integrator_state != other.integrator_state:
            return False
    ...
    @builtins.property
    def integrator_state(self):
        """Message field 'integrator_state'."""
        return self._integrator_state

    @integrator_state.setter
    def integrator_state(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'integrator_state' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'integrator_state' field must be an unsigned integer in [0, 255]"
        self._integrator_state = value
