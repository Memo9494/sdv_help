...
static rosidl_typesupport_introspection_c__MessageMember isaac_ros_visual_slam_interfaces__msg__VisualSlamStatus__rosidl_typesupport_introspection_c__VisualSlamStatus_message_member_array[7] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(isaac_ros_visual_slam_interfaces__msg__VisualSlamStatus, integrator_state),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
