...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VisualSlamStatus_message_member_array[7] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(isaac_ros_visual_slam_interfaces::msg::VisualSlamStatus, integrator_state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
