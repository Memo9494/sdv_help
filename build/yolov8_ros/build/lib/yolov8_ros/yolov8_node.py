...
class Yolov8Node(Node):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter("device", "cuda:0") #checar
        ...
        self._sub = self.create_subscription(					#subscription
            Image, "multisense/left/image_mono", self.image_cb,
    ...
    def image_cb(self, msg: Image) -> None: #msg: Image // use it for camera 
        ...
        if self.enable:
            ...
            detections_msg = Detection2DArray() #use this to publish
            ...
            #self._pub.publish(detectionsYOLO node to subscribe to a ROS2 topic that provides image data (e.g., sensor_msgs/Image). _msg) #change
...
def main():
    ...
    rclpy.spin(node)
    rclpy.shutdown()
    #captura = cv2.VideoCapture('Test_Multi0.mp4') #video name
    #while (captura.isOpened()):
    #  ret, imagen = captura.read()
    #  if ret == True:
#		self.image_cb(imagen)
