...
class CommonGroup(metaclass=Metaclass_CommonGroup):
    ...
    def magpres_temp(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'magpres_temp' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def magpres_pres(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'magpres_pres' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def deltatheta_dtime(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'deltatheta_dtime' field must be a float in [-3.402823e+38, 3.402823e+38]"
