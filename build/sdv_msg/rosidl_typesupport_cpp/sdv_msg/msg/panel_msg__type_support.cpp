...
static const _PanelMsg_type_support_symbol_names_t _PanelMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sdv_msg, msg, PanelMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sdv_msg, msg, PanelMsg)),
  }
};
...
{
  return &::sdv_msg::msg::rosidl_typesupport_cpp::PanelMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sdv_msg, msg, PanelMsg)() {
  return get_message_type_support_handle<sdv_msg::msg::PanelMsg>();
}
