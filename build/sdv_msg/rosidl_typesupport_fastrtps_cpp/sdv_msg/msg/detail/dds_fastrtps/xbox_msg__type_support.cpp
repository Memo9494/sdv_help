...
#include "sdv_msg/msg/detail/xbox_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sdv_msg::msg::XboxMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sdv_msg::msg::XboxMsg & ros_message)
{
  // Member: connected
...
{
  auto typed_message =
    static_cast<const sdv_msg::msg::XboxMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sdv_msg::msg::XboxMsg *>(
    untyped_ros_message);
...
{
  return &sdv_msg::msg::typesupport_fastrtps_cpp::_XboxMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sdv_msg, msg, XboxMsg)() {
  return &sdv_msg::msg::typesupport_fastrtps_cpp::_XboxMsg__handle;
}
