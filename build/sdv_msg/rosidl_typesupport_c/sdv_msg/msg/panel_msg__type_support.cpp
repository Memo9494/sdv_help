...
static const _PanelMsg_type_support_symbol_names_t _PanelMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sdv_msg, msg, PanelMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sdv_msg, msg, PanelMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sdv_msg, msg, PanelMsg)() {
  return &::sdv_msg::msg::rosidl_typesupport_c::PanelMsg_message_type_support_handle;
}
