...
set(_exported_libraries "slam_toolbox__rosidl_generator_c;slam_toolbox__rosidl_typesupport_c;slam_toolbox__rosidl_typesupport_cpp;toolbox_common;SlamToolboxPlugin;ceres_solver_plugin;async_slam_toolbox;sync_slam_toolbox;localization_slam_toolbox;lifelong_slam_toolbox;map_and_localization_slam_toolbox")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'slam_toolbox' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND slam_toolbox_LIBRARIES ${_cfg} "${_lib}")
