...
#include "sdv_localization_msgs/msg/detail/sensor_diag__rosidl_typesupport_fastrtps_c.h"
...
using _SensorDiag__ros_msg_type = sdv_localization_msgs__msg__SensorDiag;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SensorDiag__ros_msg_type * ros_message = static_cast<const _SensorDiag__ros_msg_type *>(untyped_ros_message);
  // Field name: is_enabled
  {
    cdr << (ros_message->is_enabled ? true : false);
  }

  // Field name: is_publishing
  {
    cdr << (ros_message->is_publishing ? true : false);
  }

  // Field name: is_changing
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SensorDiag__ros_msg_type * ros_message = static_cast<_SensorDiag__ros_msg_type *>(untyped_ros_message);
  // Field name: is_enabled
  {
    uint8_t tmp;
    cdr >> tmp;
...
static uint32_t _SensorDiag__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sdv_localization_msgs__msg__SensorDiag(
...
static size_t _SensorDiag__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sdv_localization_msgs__msg__SensorDiag(
...
static message_type_support_callbacks_t __callbacks_SensorDiag = {
...
static rosidl_message_type_support_t _SensorDiag__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SensorDiag,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sdv_localization_msgs, msg, SensorDiag)() {
  return &_SensorDiag__type_support;
}
