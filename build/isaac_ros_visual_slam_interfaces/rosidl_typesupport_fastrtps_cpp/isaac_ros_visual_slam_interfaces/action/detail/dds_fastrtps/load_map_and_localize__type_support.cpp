...
{
bool cdr_serialize(
  const isaac_ros_visual_slam_interfaces::action::LoadMapAndLocalize_Goal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const isaac_ros_visual_slam_interfaces::action::LoadMapAndLocalize_Result &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const isaac_ros_visual_slam_interfaces::action::LoadMapAndLocalize_Feedback &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
