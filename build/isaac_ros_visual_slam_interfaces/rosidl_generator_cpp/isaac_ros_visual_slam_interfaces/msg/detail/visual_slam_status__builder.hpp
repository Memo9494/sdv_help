...
class Init_VisualSlamStatus_integrator_state
{
public:
  explicit Init_VisualSlamStatus_integrator_state(::isaac_ros_visual_slam_interfaces::msg::VisualSlamStatus & msg)
  : msg_(msg)
  {}
  Init_VisualSlamStatus_node_callback_execution_time integrator_state(::isaac_ros_visual_slam_interfaces::msg::VisualSlamStatus::_integrator_state_type arg)
  {
    msg_.integrator_state = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_VisualSlamStatus_integrator_state vo_state(::isaac_ros_visual_slam_interfaces::msg::VisualSlamStatus::_vo_state_type arg)
  {
    msg_.vo_state = std::move(arg);
    return Init_VisualSlamStatus_integrator_state(msg_);
  }
