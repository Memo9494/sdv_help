...
#include "multisense_msgs/msg/detail/histogram__rosidl_typesupport_fastrtps_c.h"
...
using _Histogram__ros_msg_type = multisense_msgs__msg__Histogram;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Histogram__ros_msg_type * ros_message = static_cast<const _Histogram__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _Histogram__ros_msg_type * ros_message = static_cast<_Histogram__ros_msg_type *>(untyped_ros_message);
  // Field name: frame_count
  {
    cdr >> ros_message->frame_count;
  }
...
size_t get_serialized_size_multisense_msgs__msg__Histogram(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Histogram__ros_msg_type * ros_message = static_cast<const _Histogram__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Histogram__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_multisense_msgs__msg__Histogram(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_multisense_msgs
size_t max_serialized_size_multisense_msgs__msg__Histogram(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Histogram__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_multisense_msgs__msg__Histogram(
...
static message_type_support_callbacks_t __callbacks_Histogram = {
  "multisense_msgs::msg",
  "Histogram",
...
static rosidl_message_type_support_t _Histogram__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Histogram,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, multisense_msgs, msg, Histogram)() {
  return &_Histogram__type_support;
}
