...
class DeviceInfo(metaclass=Metaclass_DeviceInfo):
    ...
    def nominal_baseline(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'nominal_baseline' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def nominal_focal_length(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'nominal_focal_length' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def nominal_relative_aperture(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'nominal_relative_aperture' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def motor_gear_reduction(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'motor_gear_reduction' field must be a float in [-3.402823e+38, 3.402823e+38]"
