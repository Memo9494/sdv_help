...
class DeviceStatus(metaclass=Metaclass_DeviceStatus):
    ...
    def power_supply_temp(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'power_supply_temp' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def fpga_temp(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'fpga_temp' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def left_imager_temp(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'left_imager_temp' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def right_imager_temp(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'right_imager_temp' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def input_voltage(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'input_voltage' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def input_current(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'input_current' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def fpga_power(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'fpga_power' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def logic_power(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'logic_power' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def imager_power(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'imager_power' field must be a float in [-3.402823e+38, 3.402823e+38]"
